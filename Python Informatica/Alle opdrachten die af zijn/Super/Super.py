...
def make_turtles():
    global startmain, harten, ruiten, schoppen, klaver, speler_turtle1, speler_turtle2, speler_turtle3, speler_turtle4, joker_turtle, schrijf_turtle, niemand_turtle, score_turtle
